...
export default function Base() {
  ...
  const comments = [
    { text: "QA Skills made online learning so interactive and effective. Loved the dashboard!", user: "— Riya, NEET Aspirant" },
    { text: "Finally, a platform where teaching and managing students is seamless.", user: "— Mr. Singh, Math Teacher" },
    { text: "The doubt-solving and notes section is a game changer.", user: "— Kunal, JEE Prep" },
  ];
    ...
    >
      ...
      >
        ...
        <p className="text-gray-700 dark:text-gray-300 text-lg leading-7">
          Your complete EdTech solution for quality learning and effective teaching.
      ...
      >
        {[
          { title: "Interactive Learning", desc: "Quizzes, notes, and tools for fun learning." },
          { title: "Skilled Teachers", desc: "Experienced educators across all subjects." },
          { title: "Smart Dashboard", desc: "Track progress with clean reports & charts." },
        ].map((item, i) => (
          <motion.div
            key={i}
      ...
      >
        {stats.map((stat, i) => (
          <div key={i} className="bg-gray-200 dark:bg-gray-800 rounded-xl text-center p-6 border border-purple-400 dark:border-purple-600">
      ...
      {/* Testimonials */}
      <div className="mt-20 max-w-4xl mx-auto pb-10">
